package com.bfox.xunbao.common.core.filter;
...
public class ExceptionCustomizerFilter implements Filter, Filter.Listener {
	...
	public void onResponse(Result appResponse, Invoker<?> invoker, Invocation invocation) {
		if (appResponse.hasException() && GenericService.class != invoker.getInterface()) {
            try {
                ...
                if (className.startsWith("java.") || className.startsWith("javax.") || className.startsWith("com.bovine.xunbaoshu")) {
                    return;
                }
                // directly throw if it's dubbo exception
                if (exception instanceof RpcException || exception instanceof RuntimeException) {
                    return;
                }
