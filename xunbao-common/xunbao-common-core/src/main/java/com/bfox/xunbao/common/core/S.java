...
public enum S {
	...
	REPEAT_SUBMIT(602, "系统正在努力处理中...请耐心等待!"),

	SENTINEL_LIMIT(603, "系统正在努力排队中...请稍后重试!"),

	SYSTEM_UNAUTHORIZED(604, "无权限访问,请联系管理员!"),

	PARAMETER_BOUNDS_ERROR(605, "参数异常,请联系技术人员!"),
	...
	USER_NOT_PERMISSION_ERROR(1007, "无权限修改用户状态!"),

	USER_STATUS_PARAMETER_ERROR(1008, "前端状态参数传递异常!"),

	USER_REMOVE_SUPER_ADMIN_ERROR(1009, "系统超管不能被删除！"),

	USER_CURRENT_REMOVE_ERROR(1010, "当前用户不能被删除!"),

	USER_ADD_PERMISSIONS_ERROR(1011, "新增用户所选角色，不是本人创建!"),

	ADD_ROLE_NOT_PERMISSIONS_ERROR(1012, "新增角色的权限，已超出你的权限范围!"),

	MENU_BASE_FRAME_REMOVE_ERROR(2000, "主结构菜单不能被删除!"),

	MENU_CORRESPONDING_REMOVE_ERROR(2001, "请删除对应的菜单或者按钮后再删除主菜单!"),

	MENU_PARENT_MENU_ONLY_CATALOG_ERROR(2002, "父级菜单只能是目录!"),

	MENU_PARENT_MENU_ONLY_MENU_ERROR(2003, "父级菜单只能是菜单!"),
