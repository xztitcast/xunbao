package com.bfox.xunbao.framework.service;
 ...
 * @author eden
 * @date 2023年7月1日 下午10:29:04
 */
@EnableDubbo
@SpringBootApplication
@MapperScan(basePackages = {"com.bfox.xunbao.framework.mapper"})
public class FrameworkServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(FrameworkServiceApplication.class, args);
	}
