package com.bfox.xunbao.serve.gateway.filter;
...
import com.bfox.xunbao.serve.gateway.properties.XunbaoGatewayProperties;
...
public class AuthenticationManagerFilter implements GlobalFilter, Ordered {
	...
	private final XunbaoGatewayProperties properties;
	
	public AuthenticationManagerFilter(XunbaoGatewayProperties properties) {
